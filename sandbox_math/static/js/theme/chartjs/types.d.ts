...
export {
  av as ActiveDataPoint,
  aw as ActiveElement,
  a$ as Align,
  m as Animation,
  cj as AnimationEvent,
  aY as AnimationOptions,
  aU as AnimationSpec,
  o as Animations,
  aV as AnimationsSpec,
  ci as Animator,
  b4 as ArcBorderRadius,
  b5 as ArcHoverOptions,
  A as ArcOptions,
  B as BarController,
  a7 as BarControllerChartOptions,
  a6 as BarControllerDatasetOptions,
  v as BarElement,
  bh as BarHoverOptions,
  bf as BarOptions,
  be as BarProps,
  x as BasePlatform,
  y as BasicPlatform,
  bJ as BorderOptions,
  bg as BorderRadius,
  h as BubbleController,
  a8 as BubbleControllerDatasetOptions,
  a9 as BubbleDataPoint,
  b_ as CartesianParsedData,
  bP as CartesianScaleOptions,
  bW as CartesianScaleTypeRegistry,
  bM as CartesianTickOptions,
  N as CategoryScale,
  bQ as CategoryScaleOptions,
  d as Chart,
  f as ChartArea,
  aQ as ChartComponent,
  aJ as ChartComponentLike,
  ce as ChartConfiguration,
  cf as ChartConfigurationCustomTypesPerDataset,
  cc as ChartData,
  cd as ChartDataCustomTypesPerDataset,
  ca as ChartDataset,
  cb as ChartDatasetCustomTypesPerDataset,
  c8 as ChartDatasetProperties,
  c9 as ChartDatasetPropertiesCustomTypesPerDataset,
  e as ChartEvent,
  ax as ChartItem,
  au as ChartMeta,
  c5 as ChartOptions,
  c0 as ChartType,
  b$ as ChartTypeRegistry,
  ck as Color,
  b1 as CommonElementOptions,
  b2 as CommonHoverOptions,
  bo as ComplexFillTarget,
  a5 as ControllerDatasetOptions,
  aT as CoreChartOptions,
  aS as CoreInteractionOptions,
  aM as CoreScaleOptions,
  c3 as DatasetChartOptions,
  p as DatasetController,
  aA as DatasetControllerChartComponent,
  g as DateAdapter,
  F as Decimation,
  bk as DecimationAlgorithm,
  bl as DecimationOptions,
  c6 as DefaultDataPoint,
  aB as Defaults,
  z as DomPlatform,
  ag as DoughnutAnimationOptions,
  i as DoughnutController,
  ah as DoughnutControllerChartOptions,
  af as DoughnutControllerDatasetOptions,
  ai as DoughnutDataPoint,
  aj as DoughnutMetaExtensions,
  cg as EasingFunction,
  E as Element,
  bj as ElementChartOptions,
  bi as ElementOptionsByType,
  bD as ExtendedPlugin,
  bn as FillTarget,
  G as Filler,
  bp as FillerControllerDatasetOptions,
  bm as FillerOptions,
  aZ as FontSpec,
  bK as GridLineOptions,
  I as Interaction,
  aR as InteractionAxis,
  aE as InteractionItem,
  aH as InteractionMode,
  aF as InteractionModeFunction,
  aG as InteractionModeMap,
  aD as InteractionOptions,
  cl as LayoutItem,
  cm as LayoutPosition,
  H as Legend,
  br as LegendElement,
  bq as LegendItem,
  bs as LegendOptions,
  L as LineController,
  ab as LineControllerChartOptions,
  aa as LineControllerDatasetOptions,
  w as LineElement,
  b8 as LineHoverOptions,
  b7 as LineOptions,
  b6 as LineProps,
  O as LinearScale,
  bR as LinearScaleOptions,
  Q as LogarithmicScale,
  bS as LogarithmicScaleOptions,
  aC as Overrides,
  c7 as ParsedDataType,
  a4 as ParsingOptions,
  am as PieAnimationOptions,
  j as PieController,
  al as PieControllerChartOptions,
  ak as PieControllerDatasetOptions,
  an as PieDataPoint,
  ao as PieMetaExtensions,
  aI as Plugin,
  bI as PluginChartOptions,
  bH as PluginOptionsByType,
  P as Point,
  b as PointElement,
  bb as PointHoverOptions,
  ba as PointOptions,
  bd as PointPrefixedHoverOptions,
  bc as PointPrefixedOptions,
  ch as PointProps,
  b9 as PointStyle,
  aq as PolarAreaAnimationOptions,
  k as PolarAreaController,
  ar as PolarAreaControllerChartOptions,
  ap as PolarAreaControllerDatasetOptions,
  R as RadarController,
  at as RadarControllerChartOptions,
  as as RadarControllerDatasetOptions,
  U as RadialLinearScale,
  bV as RadialLinearScaleOptions,
  bX as RadialScaleTypeRegistry,
  bU as RadialTickOptions,
  aK as Registry,
  q as Scale,
  c4 as ScaleChartOptions,
  c2 as ScaleOptions,
  c1 as ScaleOptionsByType,
  bZ as ScaleType,
  bY as ScaleTypeRegistry,
  l as ScatterController,
  ae as ScatterControllerChartOptions,
  ac as ScatterControllerDatasetOptions,
  ad as ScatterDataPoint,
  $ as Scriptable,
  a2 as ScriptableAndArray,
  a3 as ScriptableAndArrayOptions,
  a1 as ScriptableAndScriptableOptions,
  bN as ScriptableCartesianScaleContext,
  bO as ScriptableChartContext,
  Y as ScriptableContext,
  Z as ScriptableLineSegmentContext,
  a0 as ScriptableOptions,
  aN as ScriptableScaleContext,
  aO as ScriptableScalePointLabelContext,
  ...
  r as Ticks,
  V as TimeScale,
  bT as TimeScaleOptions,
  W as TimeSeriesScale,
  T as TimeUnit,
  K as Title,
  bt as TitleOptions,
  M as Tooltip,
  bC as TooltipCallbacks,
  bG as TooltipItem,
  bw as TooltipLabelStyle,
  bx as TooltipModel,
  bF as TooltipOptions,
  by as TooltipPosition,
  bB as TooltipPositioner,
  bz as TooltipPositionerFunction,
  bA as TooltipPositionerMap,
  bu as TooltipXAlignment,
  bv as TooltipYAlignment,
  aW as TransitionSpec,
  aX as TransitionsSpec,
  aP as TypedRegistry,
  az as UpdateMode,
  ay as UpdateModeEnum,
  b0 as VisualElement,
  _ as _adapters,
  s as defaults,
  t as layouts,
...
declare function _detectPlatform(
  canvas: any,
