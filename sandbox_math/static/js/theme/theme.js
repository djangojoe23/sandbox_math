  ...
  (function (root, factory) {
    ...
    function (window) {
      ...
      var setHistory = function (options) {
        ...
        if (!history.replaceState || !options.updateURL || history.state)
          return;
      ...
      var SmoothScroll = function (selector, options) {
        ...
        var clickHandler = function (event) {
          ...
          anchor =
            !anchor && hash === '#top' ? document.documentElement : anchor;
  ...
  (() => {
    ...
    for (let i = 0; i < switchWrapper.length; i++) {
      ...
      switchToggle.addEventListener('change', (e) => {
        ...
        const annualSwitch = e.currentTarget.querySelector(
          '[data-annual-switch]',
        );
