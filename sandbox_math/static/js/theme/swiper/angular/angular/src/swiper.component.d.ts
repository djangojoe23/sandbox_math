...
export declare class SwiperComponent implements OnInit {
  ...
  s__beforeBreakpoint: EventEmitter<
    [swiper: Swiper, breakpointParams: SwiperOptions]
  >;
  s__containerClasses: EventEmitter<[swiper: Swiper, classNames: string]>;
  s__slideClass: EventEmitter<
    [swiper: Swiper, slideEl: HTMLElement, classNames: string]
  >;
  ...
  s_beforeTransitionStart: EventEmitter<
    [swiper: Swiper, speed: number, internal: any]
  >;
  s_breakpoint: EventEmitter<[swiper: Swiper, breakpointParams: SwiperOptions]>;
  s_changeDirection: EventEmitter<[swiper: Swiper]>;
  s_click: EventEmitter<
    [swiper: Swiper, event: PointerEvent | MouseEvent | TouchEvent]
  >;
  s_doubleTap: EventEmitter<
    [swiper: Swiper, event: PointerEvent | MouseEvent | TouchEvent]
  >;
  s_doubleClick: EventEmitter<
    [swiper: Swiper, event: PointerEvent | MouseEvent | TouchEvent]
  >;
  ...
  s_lazyImageLoad: EventEmitter<
    [swiper: Swiper, slideEl: HTMLElement, imageEl: HTMLElement]
  >;
  s_lazyImageReady: EventEmitter<
    [swiper: Swiper, slideEl: HTMLElement, imageEl: HTMLElement]
  >;
  ...
  s_scrollbarDragEnd: EventEmitter<
    [swiper: Swiper, event: PointerEvent | MouseEvent | TouchEvent]
  >;
  s_scrollbarDragMove: EventEmitter<
    [swiper: Swiper, event: PointerEvent | MouseEvent | TouchEvent]
  >;
  s_scrollbarDragStart: EventEmitter<
    [swiper: Swiper, event: PointerEvent | MouseEvent | TouchEvent]
  >;
  ...
  s_touchEnd: EventEmitter<
    [swiper: Swiper, event: PointerEvent | MouseEvent | TouchEvent]
  >;
  s_touchMove: EventEmitter<
    [swiper: Swiper, event: PointerEvent | MouseEvent | TouchEvent]
  >;
  s_touchMoveOpposite: EventEmitter<
    [swiper: Swiper, event: PointerEvent | MouseEvent | TouchEvent]
  >;
  s_touchStart: EventEmitter<
    [swiper: Swiper, event: PointerEvent | MouseEvent | TouchEvent]
  >;
  ...
  s_zoomChange: EventEmitter<
    [swiper: Swiper, scale: number, imageEl: HTMLElement, slideEl: HTMLElement]
  >;
