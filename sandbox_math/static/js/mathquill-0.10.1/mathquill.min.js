...
!(function () {
  ...
  function c(e) {
    function n(t) {
      var e, n;
      return t && t.nodeType
        ? ((e = Dt(t).children('.mq-root-block').attr(xt)),
          ...
          (t.init = function (t) {
            ...
            (t.__mathquillify = function (t) {
              ...
              n.createTextarea(),
                ...
                (i.jQ = Dt('<span class="mq-root-block"/>')
                  .attr(xt, i.id)
                  .appendTo(s)),
                this.latex(e.text()),
        ...
        (e.__mathquillify = function () {
          ...
          (e.keystroke = function (e) {
            ...
            for (
              ...
              this.__controller.keystroke(e[n], { preventDefault: t });
            return this;
          }),
          ...
          (e.dropEmbedded = function (t, e, n) {
            ...
            this.__controller.seek(Dt(o), t, e),
              (i = gt().setOptions(n)),
  ...
  function p(t, e) {
    (t.jQadd = function () {
      ...
      (t.reflow = function () {
        ...
        Y(this.delimjQs, yt(1 + 0.2 * (t - 1), 1.2), 1.2 * t);
      });
  }
  function d(t, e) {
    var e = e || t,
    ...
    Rt = Qt(_t, function (t) {
      (t.init = function (t, e) {
        ...
        (t.show = function () {
          return (
            ...
            'intervalId' in this
              ...
              : (this[Ct]
                  ? this.selection && this.selection.ends[Tt][Tt] === this[Tt]
                    ? this.jQ.insertBefore(this.selection.jQ)
                    : this.jQ.insertBefore(this[Ct].jQ.first())
        ...
        (t.select = function () {
          ...
          return (
            o === Ct && ((i = n), (r = t)),
            i instanceof _t && (i = i[Ct]),
            r instanceof _t && (r = r[Tt]),
        ...
        (t.deleteSelection = function () {
          this.selection &&
            ((this[Tt] = this.selection.ends[Tt][Tt]),
  ...
  (l.prototype = $t.p),
    ...
    (q = (function () {
      ...
      return function (n, i) {
        ...
        var d,
          ...
          q = t;
        return (
          w.bind('keydown keypress input keyup focusout paste', function (t) {
            q(t);
          }),
          (m = !1),
          w.bind({ keydown: l, keypress: c, focusout: h, paste: f }),
          { select: r }
        );
      };
    })()),
        ...
        i.textarea
          .focus(function () {
            (i.blurred = !1),
              ...
              r.selection
                ? (r.selection.jQ.removeClass('mq-blur'), i.selectionChanged())
                : r.show();
          })
          .blur(function () {
            (i.blurred = !0),
      ...
      (t.keystroke = function (t, e, n) {
        ...
        switch (t) {
          ...
          case 'Down':
            ...
            break;
          case 'Shift-Up':
            if (i[Tt]) for (; i[Tt]; ) n.selectLeft();
            else n.selectLeft();
          case 'Shift-Down':
            if (i[Ct]) for (; i[Ct]; ) n.selectRight();
            else n.selectRight();
          case 'Ctrl-Up':
            break;
          case 'Ctrl-Down':
    ...
    zt.open(function (t) {
      function e(t, e) {
        ...
        return (
          n[Ct][i]
            ? n.insAtLeftEnd(n[Ct][i])
            : n[Tt][i]
            ? n.insAtRightEnd(n[Tt][i])
      ...
      this.onNotify(function (t) {
        ...
        (t.escapeDir = function (t, e, n) {
          ...
          return (
            ...
            i.parent !== this.root
              ? (i.parent.moveOutOf(t, i), this.notify('move'))
              : void 0
          );
        }),
      ...
      (t.exportLatex = function () {
        ...
        (t.writeLatex = function (t) {
          ...
          return (
            r &&
              !r.isEmpty() &&
              (r.children().adopt(n.parent, n[Tt], n[Ct]),
              (e = r.jQize()),
              e.insertBefore(n.jQ),
              (n[Tt] = r.ends[Ct]),
              r.finalizeInsert(n.options, n),
              r.ends[Ct][Ct].siblingCreated &&
                r.ends[Ct][Ct].siblingCreated(n.options, Tt),
              r.ends[Tt][Tt].siblingCreated &&
                r.ends[Tt][Tt].siblingCreated(n.options, Ct),
      ...
      e.delegateMouseEvents = function () {
        ...
        this.container.bind('mousedown.mathquill', function (n) {
          ...
          var o,
            ...
            f = c.textareaSpan,
            p = c.textarea;
          c.blurred && (c.editable || a.prepend(f), p.focus()),
            n.preventDefault(),
            (n.target.unselectable = !0),
            (u.blink = t),
            c.seek(Dt(n.target), n.pageX, n.pageY).cursor.startSelection(),
            a.mousemove(i),
            Dt(n.target.ownerDocument).mousemove(s).mouseup(r);
        });
      };
    }),
    zt.open(function (t) {
      t.seek = function (t, e, n) {
        ...
        return (
          t &&
            ((i = t.attr(xt) || t.attr(qt)),
            i || ((r = t.parent()), (i = r.attr(xt) || r.attr(qt)))),
    ...
    zt.open(function (t) {
      t.scrollHoriz = function () {
        ...
        else if (((t = r.jQ[0].getBoundingClientRect().left), t > a.right - 20))
          e = t - (a.right - 20);
        else {
    ...
    zt.open(function (t) {
      (Bt.p.substituteTextarea = function () {
        ...
        (t.createTextarea = function () {
          ...
          (n = this.textarea = Dt(n).appendTo(e)),
            (t = this),
        ...
        (t.staticMathTextareaEvents = function () {
          ...
          this.container.prepend(
            '<span class="mq-selectable">$' + e.exportLatex() + '$</span>',
          ),
            (e.blurred = !0),
            i
              .bind('cut paste', !1)
      ...
      (t.init = function (t, n, i) {
        ...
        (t.createLeftOf = function (t) {
          ...
          n.createBlocks(),
            ...
            i && (i.adopt(n.ends[Tt], 0, 0), i.jQ.appendTo(n.ends[Tt].jQ)),
        ...
        (t.placeCursor = function (t) {
          t.insAtRightEnd(
            this.foldChildren(this.ends[Tt], function (t, e) {
        ...
        (t.html = function () {
          ...
          for (
            s('no unmatched angle brackets', a.join('') === this.htmlTemplate),
              t = 0,
              e = a[0];
            e;
            t += 1, e = a[t]
    ...
    (T = Qt(y, function (t, e) {
      (t.join = function (t) {
        ...
        (t.text = function () {
          return this.ends[Tt] === this.ends[Ct] && 0 !== this.ends[Tt]
            ? this.ends[Tt].text()
            : this.join('text');
        }),
    ...
    (D = Qt(St, function (t, e) {
      function n(t) {
        ...
        return (
          t.jQ[0].normalize(),
          (e = t.jQ[0].firstChild),
          s('only node in TextBlock span is Text node', 3 === e.nodeType),
          (n = _(e.data)),
          n.jQadd(e),
          t.children().disown(),
          n.adopt(t, 0, 0)
          ...
          t.show().deleteSelection(),
            '$' !== n
              ? t[Tt]
                ...
                : _(n).createLeftOf(t)
              : this.isEmpty()
              ? (t.insRightOf(this), j('\\$', '$').createLeftOf(t))
              : t[Ct]
              ? t[Tt]
                ? ((i = D()),
                  (s = this.ends[Tt]),
          ...
          -a * l > a * o && e[-a].moveTowards(-a, e),
            e.anticursor
              ? e.anticursor.parent === this &&
                ((c = e[Tt] && e[Tt].text.length),
                this.anticursorPosition === c
                  ? (e.anticursor = _t.copy(e))
                  : (this.anticursorPosition < c
                      ? ((u = e[Tt].splitRight(this.anticursorPosition)),
                        (e[Tt] = u))
                      : (u = e[Ct].splitRight(this.anticursorPosition - c)),
                    (e.anticursor = _t(this, u[Tt], u))))
              : (this.anticursorPosition = e[Tt] && e[Tt].text.length);
        }),
        (t.blur = function () {
      ...
      (t.init = function (t) {
        ...
        (t.moveTowards = function (t, e) {
          ...
          return (
            ...
            (i = n(-t, this.text)),
            (s = this[-t]),
            s ? s.insTextAtDirEnd(i, t) : _(i).createDir(-t, e),
        ...
        (t.selectTowards = function (t, e) {
          ...
          return (
            ...
            (s = n(-t, this.text)),
            i[t] === this
              ? ((o = _(s).createDir(t, e)), (i[t] = o), e.insDirOf(t, o))
              : ((a = this[-t]),
                a
    ...
    (At.$ = Et.text = Et.textnormal = Et.textrm = Et.textup = Et.textmd = D),
    (Et.em =
      Et.italic =
      Et.italics =
      Et.emph =
      Et.textit =
      Et.textsl =
        h('\\textit', 'i', 'class="mq-text-mode"')),
    (Et.strong =
      Et.bold =
      Et.textbf =
        h('\\textbf', 'b', 'class="mq-text-mode"')),
    (Et.sf = Et.textsf =
      h('\\textsf', 'span', 'class="mq-sans-serif mq-text-mode"')),
    (Et.tt = Et.texttt =
      h('\\texttt', 'span', 'class="mq-monospace mq-text-mode"')),
    (Et.textsc = h(
      '\\textsc',
      'span',
    ...
    (L = Qt(C, function (t, e) {
      (t.keystroke = function (t) {
        return 'Spacebar' !== t && 'Shift-Spacebar' !== t
          ? e.keystroke.apply(this, arguments)
          : void 0;
      }),
        (t.write = function (t, e) {
    ...
    (Et.lbrack = i(j, '[')),
    (Et.rbrack = i(j, ']')),
    (Et['∫'] = Et['int'] = Et.integral = i(k, '\\int ', '<big>&int;</big>')),
    (Et.slash = i(j, '/')),
    (Et.vert = i(j, '|')),
    ...
    (A = Qt(j, function (t, e) {
      t.createLeftOf = function (t) {
        ...
        ((t[Tt] instanceof R && t[Tt].isItalic !== !1) ||
          (t[Tt] instanceof rt &&
            t[Tt][Tt] instanceof R &&
            t[Tt][Tt].isItalic !== !1))
          ? (Et._().createLeftOf(t),
            e.createLeftOf.call(this, t),
    ...
    (R = Qt(k, function (t, e) {
      (t.init = function (t, n) {
        ...
        (t.text = function () {
          ...
          return (
            !this[Tt] ||
              this[Tt] instanceof R ||
              this[Tt] instanceof Q ||
              '\\ ' === this[Tt].ctrlSeq ||
              (t = '*' + t),
            !this[Ct] ||
              this[Ct] instanceof Q ||
              this[Ct] instanceof rt ||
              (t += '*'),
            t
          );
        });
    })),
    (Bt.p.autoCommands = { _maxLength: 0 }),
      ...
      (t.init = function (t) {
        ...
        (t.createLeftOf = function (t) {
          var n,
            ...
            o = r._maxLength;
          if (o > 0) {
            for (n = this.letter, i = t[Tt], s = 1; i instanceof I && o > s; )
              (n = i.letter + n), (i = i[Tt]), (s += 1);
            for (; n.length; ) {
        ...
        (t.autoUnItalicize = function (t) {
          ...
          if (0 !== p._maxLength) {
            for (e = this.letter, i = this[Tt]; i instanceof I; i = i[Tt])
              e = i.letter + e;
            for (s = this[Ct]; s instanceof I; s = s[Ct]) e += s.letter;
            Lt(
              i[Ct] || this.parent.ends[Tt],
              s[Tt] || this.parent.ends[Ct],
            ).each(function (t) {
              t.italicize(!0).jQ.removeClass('mq-first mq-last'),
                (t.ctrlSeq = t.letter);
            });
            t: for (
              r = 0, o = i[Ct] || this.parent.ends[Tt];
              r < e.length;
              r += 1, o = o[Ct]
            )
              for (a = yt(p._maxLength, e.length - r); a > 0; a -= 1)
                if (((l = e.slice(r, r + a)), p.hasOwnProperty(l))) {
                  for (c = 0, u = o; a > c; c += 1, u = u[Ct])
                    u.italicize(!1), (h = u);
                  (f = z.hasOwnProperty(l)),
                    (o.ctrlSeq = (f ? '\\' : '\\operatorname{') + o.ctrlSeq),
                    (h.ctrlSeq += f ? ' ' : '}'),
                    B.hasOwnProperty(l) && h[Tt][Tt][Tt].jQ.addClass('mq-last'),
                    n(o[Tt]) && o.jQ.addClass('mq-first'),
                    n(h[Ct]) && h.jQ.addClass('mq-last'),
                    (r += a - 1),
                    (o = h);
                  continue t;
                }
    ...
    (z = {}),
    (M = Bt.p.autoOperatorNames = { _maxLength: 9 }),
    (B = { limsup: 1, liminf: 1, projlim: 1, injlim: 1 }),
    (function () {
      var t,
        e,
        n,
      ...
      (t.init = function (t) {
        ...
        (t.parser = function () {
          ...
          for (t = 0; t < e.length; t += 1)
            I(e.charAt(t)).adopt(n, n.ends[Ct], 0);
  ...
  (Et.operatorname = Qt(O, function (e) {
    ...
    (Et.phi = i(R, '\\phi ', '&#981;')),
    (Et.phiv = Et.varphi = i(R, '\\varphi ', '&phi;')),
    (Et.epsilon = i(R, '\\epsilon ', '&#1013;')),
    (Et.epsiv = Et.varepsilon = i(R, '\\varepsilon ', '&epsilon;')),
    (Et.piv = Et.varpi = i(R, '\\varpi ', '&piv;')),
    (Et.sigmaf = Et.sigmav = Et.varsigma = i(R, '\\varsigma ', '&sigmaf;')),
    (Et.thetav = Et.vartheta = Et.thetasym = i(R, '\\vartheta ', '&thetasym;')),
    (Et.upsilon = Et.upsi = i(R, '\\upsilon ', '&upsilon;')),
    (Et.gammad = Et.Gammad = Et.digamma = i(R, '\\digamma ', '&#989;')),
    (Et.kappav = Et.varkappa = i(R, '\\varkappa ', '&#1008;')),
    (Et.rhov = Et.varrho = i(R, '\\varrho ', '&#1009;')),
    (Et.pi = Et['π'] = i(N, '\\pi ', '&pi;')),
    (Et.lambda = i(N, '\\lambda ', '&lambda;')),
    (Et.Upsilon =
      Et.Upsi =
      Et.upsih =
      Et.Upsih =
        i(k, '\\Upsilon ', '<var style="font-family: serif">&upsih;</var>')),
    (Et.Gamma =
      Et.Delta =
      Et.Theta =
      Et.Lambda =
      ...
      (t.init = function (t) {
        ...
        (t.createLeftOf = function (t) {
          ...
          e.children().adopt(t.parent, t[Tt], t[Ct]),
            ...
            e.ends[Ct][Ct].siblingCreated &&
              e.ends[Ct][Ct].siblingCreated(t.options, Tt),
            e.ends[Tt][Tt].siblingCreated &&
              e.ends[Tt][Tt].siblingCreated(t.options, Ct),
    ...
    (Et['+'] = i(U, '+', '+')),
    (Et['–'] = Et['-'] = i(U, '-', '&minus;')),
    (Et['±'] = Et.pm = Et.plusmn = Et.plusminus = i(U, '\\pm ', '&plusmn;')),
    (Et.mp = Et.mnplus = Et.minusplus = i(U, '\\mp ', '&#8723;')),
    ...
    (W = Qt(Q, function (t, e) {
      (t.init = function (t, n) {
        ...
        (t.deleteTowards = function (t, n) {
          return t !== Tt || this.strict
            ? void e.deleteTowards.apply(this, arguments)
            : (this.swap(!0), void this.bubble('reflow'));
        });
    })),
    (H = {
      ctrlSeq: '\\le ',
    ...
    (Et['<'] = Et.lt = i(W, H, !0)),
    (Et['>'] = Et.gt = i(W, G, !0)),
    (Et['≤'] = Et.le = Et.leq = i(W, H, !1)),
    (Et['≥'] = Et.ge = Et.geq = i(W, G, !1)),
    (K = Qt(Q, function (t, e) {
      (t.init = function () {
        e.init.call(this, '=', '=');
      }),
        (t.createLeftOf = function (t) {
          return t[Tt] instanceof W && t[Tt].strict
            ? (t[Tt].swap(!1), void t[Tt].bubble('reflow'))
            : void e.createLeftOf.apply(this, arguments);
        });
    })),
    (Et['='] = K),
  ...
  tt
    ...
    (Et.mathrm = i(nt, '\\mathrm', 'span', 'class="mq-roman mq-font"')),
    (Et.mathit = i(nt, '\\mathit', 'i', 'class="mq-font"')),
    (Et.mathbf = i(nt, '\\mathbf', 'b', 'class="mq-font"')),
    (Et.mathsf = i(nt, '\\mathsf', 'span', 'class="mq-sans-serif mq-font"')),
    (Et.mathtt = i(nt, '\\mathtt', 'span', 'class="mq-monospace mq-font"')),
    (Et.underline = i(
      nt,
      '\\underline',
      'span',
    ...
    (Et.overline = Et.bar =
      i(nt, '\\overline', 'span', 'class="mq-non-leaf mq-overline"')),
    (Et.overrightarrow = i(
      nt,
      '\\overrightarrow',
      'span',
    ...
    (it = Et.textcolor =
      Qt(O, function (t, e) {
        (t.setColor = function (t) {
          (this.color = t),
            (this.htmlTemplate =
              '<span class="mq-textcolor" style="color:' + t + '">&0</span>');
        }),
          (t.latex = function () {
            return (
    ...
    (rt = Qt(O, function (t, e) {
      (t.ctrlSeq = '_{...}^{...}'),
        (t.createLeftOf = function (t) {
          return t[Tt] || !t.options.supSubsRequireOperand
            ? e.createLeftOf.apply(this, arguments)
            : void 0;
        }),
                ...
                (i = this[n]),
                  ...
                  i &&
                    (s
                      ? i.isEmpty()
                        ? (o = _t(s, 0, s.ends[Tt]))
                        : (i.jQ.children().insAtDirEnd(-e, s.jQ),
                          (r = i.children().disown()),
                          (o = _t(s, r.ends[Ct], s.ends[Tt])),
                          e === Tt
                            ? r.adopt(s, s.ends[Ct], 0)
                            : r.adopt(s, 0, s.ends[Tt]))
        ...
        (t.deleteTowards = function (t, n) {
          if (n.options.autoSubscriptNumerals && this.sub) {
            ...
            i instanceof k
              ...
              this.sub.isEmpty() &&
                (this.sub.deleteOutOf(Tt, n.insAtLeftEnd(this.sub)),
          ...
          for (var e = 0; 2 > e; e += 1)
            (function (t, e, n, i) {
              t[e].deleteOutOf = function (s, r) {
                if (
                  (r.insDirOf(this[s] ? -s : s, this.parent), !this.isEmpty())
                ) {
                  var o = this.ends[s];
                  this.children()
                    .disown()
                ...
                (t.supsub = n),
                  ...
                  'sub' === e &&
                    Dt(t.jQ.addClass('mq-sup-only')[0].lastChild).remove(),
                  this.remove();
              };
            })(
              this,
        ...
        (t.createLeftOf = function (t) {
          e.createLeftOf.apply(this, arguments),
            t.options.sumStartsWithNEquals &&
              (I('n').createLeftOf(t), K().createLeftOf(t));
        }),
        (t.latex = function () {
          function t(t) {
          ...
          return (
            this.ctrlSeq +
            '_' +
            t(this.ends[Tt].latex()) +
            '^' +
            t(this.ends[Ct].latex())
          );
        }),
        (t.parser = function () {
          var t,
    ...
    (Et['∑'] = Et.sum = Et.summation = i(ot, '\\sum ', '&sum;')),
    (Et['∏'] = Et.prod = Et.product = i(ot, '\\prod ', '&prod;')),
    (Et.coprod = Et.coproduct = i(ot, '\\coprod ', '&#8720;')),
    (at =
      Et.frac =
      Et.dfrac =
      Et.cfrac =
          ...
          e.createLeftOf = function (e) {
            if (!this.replacedFragment) {
              ...
              i instanceof ot &&
                ...
                ((i = i[Ct]),
                i[Ct] instanceof rt &&
                  i[Ct].ctrlSeq != i.ctrlSeq &&
                  (i = i[Ct])),
                i !== e[Tt] &&
                  (this.replaces(Lt(i[Ct] || e.parent.ends[Tt], e[Tt])),
                  (e[Tt] = i));
            }
              ...
              return x.optBlock
                .then(function (t) {
                  return x.block.map(function (e) {
                    var n = ht();
                    return (
                      (n.blocks = [t, e]), t.adopt(n, 0, 0), e.adopt(n, t, 0), n
                    );
                  });
                })
    ...
    (ft = Qt(Qt(O, p), function (e, n) {
      (e.init = function (t, e, i, s, r) {
        n.init.call(this, '\\left' + s, m, [e, i]),
          (this.side = t),
          (this.sides = {}),
          (this.sides[Tt] = { ch: e, ctrlSeq: s }),
          (this.sides[Ct] = { ch: i, ctrlSeq: r });
      }),
        (e.numBlocks = function () {
          return 1;
        }),
        ...
        (e.latex = function () {
          return (
            '\\left' +
            this.sides[Tt].ctrlSeq +
            this.ends[Tt].latex() +
            '\\right' +
            this.sides[Ct].ctrlSeq
          );
        }),
        (e.oppBrack = function (t, e, n) {
          return (
            ...
            (!t.restrictMismatchedBrackets ||
              pt[this.sides[this.side].ch] === e.sides[e.side].ch ||
              { '(': ']', '[': ')' }[this.sides[Tt].ch] === e.sides[Ct].ch) &&
            e
          );
        }),
        ...
        (e.createLeftOf = function (t) {
          ...
          this.replacedFragment ||
            ((e = t.options),
            (i =
              this.oppBrack(e, t[Tt], Tt) ||
              this.oppBrack(e, t[Ct], Ct) ||
              this.oppBrack(e, t.parent.parent))),
            i
              ? ((s = this.side = -i.side),
                this.closeOpposing(i),
                i === t.parent.parent &&
                  t[s] &&
                  (Lt(t[s], t.parent.ends[s], -s)
                    .disown()
              ...
              : ((i = this),
                ...
                i.replacedFragment
                  ? (i.side = 0)
                  : t[-s] &&
                    (i.replaces(Lt(t[-s], t.parent.ends[-s], s)), (t[-s] = 0)),
                n.createLeftOf.call(i, t)),
            s === Tt ? t.insAtLeftEnd(i.ends[Tt]) : t.insRightOf(i);
        }),
        (e.placeCursor = t),
        (e.unwrap = function () {
          this.ends[Tt].children()
            .disown()
            .adopt(this.parent, this, this[Ct])
        ...
        (e.deleteSide = function (t, e, n) {
          ...
          if (t === this.side)
            return (
              this.unwrap(), void (a ? n.insDirOf(-t, a) : n.insAtDirEnd(t, o))
            );
          if (
            ((i = n.options),
            (s = !this.side),
            ...
            a
              ? ((r = this.ends[Tt].ends[t]),
                Lt(a, l, -t)
                  .disown()
                  .withDirAdopt(-t, this.ends[Tt], r, 0)
                  .jQ.insAtDirEnd(t, this.ends[Tt].jQ.removeClass('mq-empty')),
                r.siblingCreated && r.siblingCreated(n.options, t),
                n.insDirOf(-t, a))
              : e
              ? n.insDirOf(t, this)
              : n.insAtDirEnd(t, this.ends[Tt]);
          }
        }),
        (e.deleteTowards = function (t, e) {
    ...
    d('['),
    d('{', '\\{'),
    (Et.langle = i(ft, Tt, '&lang;', '&rang;', '\\langle ', '\\rangle ')),
    (Et.rangle = i(ft, Ct, '&lang;', '&rang;', '\\langle ', '\\rangle ')),
    (At['|'] = i(ft, Tt, '|', '|', '|', '|')),
    ...
    (Et.editable = Et.MathQuillMathField =
      Qt(O, function (t, e) {
